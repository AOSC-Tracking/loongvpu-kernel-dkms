...
struct vcmd_config vcmd_core_array[VCMD_SLICE_NUM][2] = {
    {
                { 0x600000, 27*4, -1, 0, 0x1000, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, { 0xFFFF, 0xFFFF } },
       //{ 0x500000, 30*4, -1, 2, 0x800, 0xFFFF, 0xFFFF, 0x1400, 0xFFFF, { 0xFFFF, 0xFFFF } }
    },
};
*/
...
struct vcmd_config vcmd_core_array[1][2] = {
    {
		{ 0, 30*4, 1, 2, 0x800, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, { 0xFFFF, 0xFFFF } },
		{ 0, 30*4, 2, 0, 0x1000, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, { 0xFFFF, 0xFFFF } },
       //{ 0x500000, 30*4, -1, 2, 0x800, 0xFFFF, 0xFFFF, 0x1400, 0xFFFF, { 0xFFFF, 0xFFFF } }
    },
};
