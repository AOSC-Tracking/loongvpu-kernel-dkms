...
/*supported core type*/
typedef enum {
	HANTRO_CORE_UNKNOWN = -1,
	HANTRO_CORE_SLICE = 1 << 0,
	HANTRO_CORE_DEC = 1 << 1,
	HANTRO_CORE_ENC = 1 << 2,
	HANTRO_CORE_IM = 1 << 3,
	HANTRO_CORE_DECJPG = 1 << 4,
	HANTRO_CORE_ENCJPG = 1 << 5,
	HANTRO_CORE_CACHE = 1 << 6,
	HANTRO_CORE_DEC400 = 1 << 7,
	HANTRO_CORE_MMU = 1 << 8,
	HANTRO_CORE_VCMD = 1 << 9,
	HANTRO_CORE_AXIFE = 1 << 10,
} slice_coretype;
...
struct cache_dev_t {
	...
	/* either struct hantroenc_t or struct hantrodec_t, or slice itself */
	void *parentcore;
	void *parentslice;
...
#define HANTRO_VC9000D_REGS 768 /*VC9000D total regs*/
